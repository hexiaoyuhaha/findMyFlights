...
'''
My specifications for searching flights:

Departure time: friday night
Return time: Sunday night or afternoon
Airport: Washington, DC, United States (WAS)
    - no BWI
...
if __name__ == "__main__":
    ...
    source = "Washington, DC, United States (WAS)"
    destination = "Pittsburgh, PA, United States (PIT)"
    date = "12/21/2017"
    ...
    with open('data/%s-%s-flight-results.json' % ('DC', 'PIT'), 'w') as fp:
